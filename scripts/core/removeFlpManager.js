...
async function main() {
  ...
  await sendTxn(gplp.setMinter(gplpManager.address, false), "gplp.setMinter")
  await sendTxn(usdg.removeVault(gplpManager.address), "usdg.removeVault")
  await sendTxn(vault.setManager(gplpManager.address, false), "vault.setManager")
}
