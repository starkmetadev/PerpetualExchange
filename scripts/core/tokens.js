...
module.exports = {
  ...
  butanetest: {
    wbbc: {
      name: "wbbc",
      address: "0xc71691d2586722307Bc1105F01E2C312b43d02E5",
      decimals: 18,
      priceFeed: "0x61E9354aFF33bD44fC31a24D308BA0C2A6167f15",
      priceDecimals: 8,
      fastPricePrecision: 1000,
      maxCumulativeDeltaDiff: 0.20 * 10 * 1000 * 1000, // 20%
      isStrictStable: false,
    ...
    usdt: {
      name: "usdt",
      address: "0x55f6e29e5e11d972507f17fc41a8d8FC19eD0cD5",
      decimals: 18,
      priceFeed: "0x2083a09CD07DaE0E140F8eC429D75C8DD282C48b",
      priceDecimals: 8,
      isStrictStable: true,
      tokenWeight: 33000,
      minProfitBps: 0,
  ...
  butane: {
    wbbc: {
      name: "wbbc",
      address: "0x35d04AA7c2205CBf11b040e0243BF896Dd2a4FFb",
      decimals: 18,
      priceFeed: "0xE8fd8B325d973922378e67D7dD9CC8C0C996AA35",
      priceDecimals: 8,
      fastPricePrecision: 1000,
      maxCumulativeDeltaDiff: 0.20 * 10 * 1000 * 1000, // 20%
      isStrictStable: false,
    ...
    gusd: {
      name: "gusd",
      address: "0xB261D56b2b7E520544cf1624dCD379C8C1390E46",
      decimals: 18,
      priceFeed: "0x283D865CDa3373913B3f37D1645B146DFA402253",
      priceDecimals: 8,
      isStrictStable: true,
      tokenWeight: 33000,
      minProfitBps: 0,
  ...
  pulse: {
    pls: {
      ...
      decimals: 18,
      priceFeed: "0x2214DcB68D7379797B480636DdbA967529269598",
      priceDecimals: 8,
    ...
    btc: {
      ...
      decimals: 8,
      priceFeed: "0x3656a92a0047D24aa6228E85D14ebF78698175d6",
      priceDecimals: 8,
      fastPricePrecision: 1000,
      maxCumulativeDeltaDiff: 0.10 * 10 * 1000 * 1000, // 10%
      isStrictStable: false,
    ...
    eth: {
      ...
      decimals: 18,
      priceFeed: "0xFaC283958CFE4a1300F79f03d3f654E8CE88F092",
      priceDecimals: 8,
      fastPricePrecision: 1000,
      maxCumulativeDeltaDiff: 0.10 * 10 * 1000 * 1000, // 10%
      isStrictStable: false,
    ...
    plsx: {
      ...
      decimals: 18,
      priceFeed: "0xC9C16F583086d91Ee93A8e82698DEEaECA8287C9",
      priceDecimals: 8,
      fastPricePrecision: 10000000,
      maxCumulativeDeltaDiff: 0.10 * 10 * 1000 * 1000, // 10%
      isStrictStable: false,
    ...
    //   decimals: 18,
    //   priceFeed: "0x4aFf46D0FF85DB772D56eDD87351d9481f1935E7",
    //   priceDecimals: 8,
    //   fastPricePrecision: 1000,
    //   maxCumulativeDeltaDiff: 0.10 * 10 * 1000 * 1000, // 10%
    //   isStrictStable: false,
    ...
    hex: {
      ...
      decimals: 8,
      priceFeed: "0x513a06ad6624D20D5159a9eee3BB15335D36C63c",
      priceDecimals: 8,
    ...
    usdt: {
      ...
      decimals: 6,
      priceFeed: "0x00f8e3121C4bE94d015D01d56fFD2F8996e34A1C",
      priceDecimals: 8,
      isStrictStable: true,
      tokenWeight: 12500,
      minProfitBps: 0,
    ...
    usdc: {
      ...
      decimals: 6,
      priceFeed: "0xdf55F7B376b2Af3661248245c5A4D75B97d66941",
      priceDecimals: 8,
      isStrictStable: true,
      tokenWeight: 12500,
      minProfitBps: 0,
    ...
    dai: {
      ...
      decimals: 18,
      priceFeed: "0x9a8384f520f16C3C88EfAd3303199E75fAEa6d2a",
      priceDecimals: 8,
      isStrictStable: true,
      tokenWeight: 12500,
      minProfitBps: 0,
