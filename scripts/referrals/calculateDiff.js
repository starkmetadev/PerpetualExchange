...
async function main() {
  ...
  const output = {
    gplxPrice: baseData.gplxPrice,
    esgplxRewards: baseData.esgplxRewards,
  ...
  output.referrers = baseData.referrers.map(x => {
    ...
    return {
      ...
      esgplxRewards: BigNumber.from(x.esgplxRewards || 0).sub(BigNumber.from(y.esgplxRewards || 0)).toString(),
      baseEsgplxRewards: x.esgplxRewards || 0,
      otherEsgplxRewards: y.esgplxRewards || 0,

      esgplxRewardsUsd: BigNumber.from(x.esgplxRewardsUsd || 0).sub(BigNumber.from(y.esgplxRewardsUsd || 0)).toString(),
      baseEsgplxRewardsUsd: x.esgplxRewardsUsd,
      otherEsgplxRewardsUsd: y.esgplxRewardsUsd,
