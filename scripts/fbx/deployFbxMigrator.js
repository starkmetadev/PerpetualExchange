...
async function main() {
  ...
  const gplxMigrator = await deployContract("GplxMigrator", [2])
  const gmtGplxIou = await deployContract("GplxIou", [gplxMigrator.address, "GMT GPLX (IOU)", "GMT:GPLX"])
  const xgmtGplxIou = await deployContract("GplxIou", [gplxMigrator.address, "xGMT GPLX (IOU)", "xGMT:GPLX"])
  const gmtUsdgGplxIou = await deployContract("GplxIou", [gplxMigrator.address, "GMT-USDG GPLX (IOU)", "GMT-USDG:GPLX"])
  const xgmtUsdgGplxIou = await deployContract("GplxIou", [gplxMigrator.address, "xGMT-USDG GPLX (IOU)", "xGMT-USDG:GPLX"])
  ...
  const gplxPrice = bigNumberify(2 * precision)
  ...
  const iouTokens = [gmtGplxIou.address, xgmtGplxIou.address, gmtUsdgGplxIou.address, xgmtUsdgGplxIou.address]
