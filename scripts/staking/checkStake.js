...
async function main() {
  ...
  console.log("stakedGplxTracker.claimable", (await stakedGplxTracker.claimable(account)).toString())
  console.log("bonusGplxTracker.claimable", (await bonusGplxTracker.claimable(account)).toString())
  console.log("feeGplxTracker.claimable", (await feeGplxTracker.claimable(account)).toString())
}
