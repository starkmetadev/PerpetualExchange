...
const { DISTRIBUTION_LIST } = require("../../data/esGplxDistribution/distributionList1")
...
async function main() {
  ...
  await sendTxn(esGplx.approve(batchSender.address, expandDecimals(100 * 1000, 18)), "esGplx.approve")
